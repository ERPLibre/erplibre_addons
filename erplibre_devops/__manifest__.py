...

{
    ...
    "data": [
        ...
        "views/devops_test_cg_exec.xml",
        "views/devops_test_devops_exec.xml",
        "views/devops_test_plan.xml",
        "views/devops_test_plan_cg.xml",
        "views/devops_test_plan_devops.xml",
