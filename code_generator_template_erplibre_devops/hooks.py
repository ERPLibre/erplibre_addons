...
def post_init_hook(cr, e):
    with api.Environment.manage():
        ...
        value["template_model_name"] = (
            ...
            " devops.deploy.docker.compose; devops.deploy.docker.container;"
            " devops.deploy.docker.image; devops.deploy.docker.network;"
            " devops.deploy.docker.volume; devops.deploy.vm;"
            " devops.deploy.vm.exec; devops.deploy.vm.exec.stage;"
            " devops.deploy.vm.snapshot; devops.exec; devops.exec.bundle;"
            ...
            " erplibre.config.path.home; erplibre.mode; erplibre.mode.env;"
